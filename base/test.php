				...
				<div class="modal-dialog" role="document">
					<div class="modal-content modal-content-demo">
						<div class="modal-header">
						 ...
						 <div class="modal-body">
                <form id="formNew" action="action.php" method="post" autocomplete="off" enctype="multipart/form-data">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                ...
                                <div class="input-group col-md-6">
                                    ...
                                    </div><input class="form-control fc-datepicker" name="_deliveryDate" id="_deliveryDate" placeholder="Delivery Date" type="text">
                                    <span class="text-danger"></span>
                                </div>
                            </div>
                            <div class="row row-sm">
                    ...
                    <div class="form-group mb-0 mt-3 justify-content-end">
                        <div>
                            <button id="_add" type="button" class="btn btn-primary btn-size">Add</button>
                        </div>
                    </div>
                </form>
            </div>
			...
			$("#demo").FancyFileUpload({
				...
				added : function(e,data){
					$("#_add").on("click",function(){
						if(sendData){
							data.formData = $("#formNewOrder").serializeArray();
							sendData = false;
						}
						data.submit();
