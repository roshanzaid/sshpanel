<?php
	...
	* APP_LOG()													//LOG WRITING
	...
	/**
	 * SAVES MANUALLY ENTERED ORDER INTO PRODUCT
	 * SAVES MANUALLY ENTERED ORDER INTO SALES AGREEMENT
	 * SAVES MANUALLY ENTERED ORDER INTO CUSTOMER
	 * RETREIVES USER ENTRY FROM ADDNEWORDER.PHP AND STORES IT 
	 * IN LOCAL VARIABLES
	 */
	if (isset($_POST['_newInvoiceId']) ||
		isset($_POST['_newDeliveryDate']) ||
		isset($_POST['_newItemName']) ||
		isset($_POST['_newItemColor']) ||
		isset($_POST['_newItemSize']) ||
		isset($_POST['_newItemFrom']) ||
		isset($_POST['_newDeliveryLocation']) ||
		isset($_POST['_newStatus']) ||
		isset($_POST['_newQuantity']) ||
		isset($_POST['_newOrderNote']) ||
		isset($_FILES['_newDeliveryNoteFile']) ||
		isset($_POST['_newSalesConsultant']) ||
		isset($_FILES['_newOrderImage']) ||
		isset($_POST['_newCat_Id']) ||
		isset($_POST['_newPaymentTerms']) ||
		isset($_POST['_newCondition']) ||
		isset($_FILES['_newSwatchImage']) ||
		isset($_FILES['_newCustomerName']) ||
		isset($_FILES['_newCustomerAddress']) ||
		isset($_FILES['_newCustomerEmail']) ||
		isset($_FILES['_newCustomerPhone']))
		{
			...
			$customerName = $_POST['_newCustomerName'];
            $customerAddress = $_POST['_newCustomerAddress'];
            $customerPhone = $_POST['_newCustomerEmail'];
            $customerEmail = $_POST['_newCustomerPhone'];
