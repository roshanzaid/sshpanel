			...
			<div class="main-content horizontal-content">
				<div class="container">
					<div class="breadcrumb-header justify-content-between">
						<div class="my-auto">
							<div class="d-flex">
								<h4 class="content-title mb-0 my-auto">Sales Agreement</h4><span class="text-muted mt-1 tx-13 ml-2 mb-0">/ Customer Confirmed Agreements</span>
							</div>
						</div>
